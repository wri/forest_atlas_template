define([], function () {
  ...
  return {
    ...
    options: [{
      ...
      name: 'Potential for commercial plantation as buffer zone to protected areas and national forest priority areas'
    }, {
      id: '$5',
      label: 'Potential for commercial plantation on bare soil and shrubland',
      name: 'Potential for commercial plantation on bare soil and shrubland'
    }, {
      id: '$6',
      label: 'Potential for establishing natural forest outside of cropland',
      name: 'Potential for establishing natural forest outside of cropland'
    }, {
      id: '$7',
      label: 'Potential for restocking of degraded natural forest',
